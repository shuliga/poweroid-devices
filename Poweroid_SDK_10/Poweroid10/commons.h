...
#define REMOTE_DISABLE  PWR_FLAGS & FLAG_REMOTE_DISABLE != 0
#define REMOTE_OVERRIDE PWR_FLAGS & FLAG_REMOTE_OVERRIDE != 0
#define REMOTE_SERVER   PWR_FLAGS & FLAG_REMOTE_SERVER != 0
#define REMOTE_STORE    PWR_FLAGS & FLAG_REMOTE_STORE != 0

#define PRESET_SERVER   REMOTE_OVERRIDE && REMOTE_SERVER
#define PRESET_CLIENT   REMOTE_OVERRIDE && !REMOTE_SERVER
